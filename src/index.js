...
const ticket = new EmbedBuilder()
    ...
    .setDescription('**Press the button below this message depending on what you need help to contact the Nameserver Support Team.**\n `Please express you question or report directly on your ticket instead of saying -help- or -I need help- (we assume you help by contacting us).` \n\n __**Ticket information**__\n`•`\n`•`')
    .setImage('LinkBanner')
    .setFooter({ text: 'name Network | IP NameServer.com', iconURL: 'linklogo' });
